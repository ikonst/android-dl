...
#define METHOD_NAME(class, method) Java_android_dl_##class##_##method
...
/*
 * Class:     android_dl.LibraryLoader
 * Method:    setup
 * Signature: (Ljava/lang/String;[Ljava/lang/String;)Z
 */
extern "C"
JNIEXPORT
jboolean JNICALL METHOD_NAME(LibraryLoader, setup)
  (JNIEnv *env, jclass, jstring dataDir, jobjectArray ld_library_path)
{
	if ((dataDir == NULL) || (ld_library_path == NULL))
	{
    ...
    const char *dataDirPath = env->GetStringUTFChars(dataDir, NULL);
	if (dataDirPath == NULL)
	{
    ...
    char *lib_dir = (char*)malloc(strlen(dataDirPath) + 5);
...
extern "C"
JNIEXPORT
jobjectArray JNICALL METHOD_NAME(LibraryLoader, dlneeds)
...
extern "C"
JNIEXPORT
jlong JNICALL METHOD_NAME(LibraryLoader, dlopen)
  (JNIEnv *env, jclass, jstring library)
{
	if (library == NULL)
	{
...
extern "C"
JNIEXPORT
jlong JNICALL METHOD_NAME(LibraryLoader, dlsym)
...
extern "C"
JNIEXPORT
jint JNICALL METHOD_NAME(LibraryLoader, dlcall)
